...
@stop
@section('content')
<form method="post" id="admin-form" action="{{ route('admin.customer.ratings.save') }}" enctype="multipart/form-data" data-parsley-validate="true">
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res['status'] == 0) {
                    ...
                    setTimeout(function() {
                       window.location.href = "{{ route('admin.customer.ratings.index') }}";
                    }, 1500);
