...
@stop
@section('content')
<form method="post" id="admin-form" action="{{ url('admin/save_category') }}" enctype="multipart/form-data" data-parsley-validate="true">
    <div class="card mb-5">
        <div class="card-body">
            <div class="">
    ...
    <div class="card mb-5">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Image @if(!$id) <b class="text-danger">*</b> @endif</label><br>

                        <input type="file" name="image" class="form-control" data-role="file-image" @if(!$id) required @endif data-preview="image-preview" data-parsley-trigger="change" accept="image/jpeg, image/png, image/gif" data-parsley-fileextension="jpg,png,gif,jpeg" data-parsley-fileextension-message="Only files with type jpg,png,gif,jpeg are supported" data-parsley-max-file-size="5120" data-parsley-max-file-size-message="Max file size should be 5MB" data-parsley-imagedimensions="300x300">
                        <span class="text-info">Upload image with only dimension</span><br>

                        <img id="image-preview" style="width:100px; height:90px;" class="img-responsive mt-4" @if ($image) src="{{ asset($image) }}" @endif>
                    </div>
                </div>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res['status'] == 0) {
                    ...
                    setTimeout(function() {
                        window.location.href = "{{ route('admin.package.category') }}";
                    }, 1500);
