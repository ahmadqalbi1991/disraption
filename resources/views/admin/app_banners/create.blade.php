...
@stop
@section('content')
<form method="post" id="admin-form" action="{{ route('admin.app_banners.save') }}" enctype="multipart/form-data" data-parsley-validate="true">
    <div class="card mb-5">
        <div class="card-body">
            <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <img id="image-preview" style="width:100px; height:90px;" class="img-responsive mt-4" @if ($banner_image) src="{{ $banner_image }}" @endif>
                    </div>
                </div>
            ...
            success: function(res) {
                ...
                if (res['status'] == 0) {
                    if (typeof res['errors'] !== 'undefined') {
                        ...
                        var m = res['message'] ||
                            'Unable to save banner. Please try again later.';
                        App.alert(m, 'Oops!');
                    }
                } else {
                    App.alert(res['message'], 'Success!');
                    setTimeout(function() {
                        window.location.href = "{{ route('admin.app_banners.index') }}";
                    }, 1500);
