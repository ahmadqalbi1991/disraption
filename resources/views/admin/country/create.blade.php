            ...
            <div class="row">
                <div class="col-md-6 mb-2">
                    <div class="form-group">
                        ...
                        <input id="name-input" type="text" name="name" class="form-control" required data-parsley-required-message="Enter Country Name" value="{{ $name }}">
                        <script>
                ...
                <div class="col-md-6 mb-2">
                    <div class="form-group">
                        ...
                        <input id="countrycode" type="text" name="prefix" class="form-control" required data-parsley-required-message="Enter Country Code" maxlength="5" value="{{ $prefix }}">
                        <script>
                            // Allow only numbers
                ...
                <div class="col-md-6 mb-2">
                    <div class="form-group">
                        ...
                        <input type="text" id="dial_code" name="dial_code" class="form-control" maxlength="4" required data-parsley-required-message="Enter Dial Code" data-parsley-type="digits" value="{{ $dial_code }}">
                        <script>
                            // Allow only numbers
                            document.getElementById('dial_code').addEventListener('input', function(e) {
                                const input = e.target;
                                input.value = input.value.replace(/[^0-9]/g, '');
                            });
                        </script>
