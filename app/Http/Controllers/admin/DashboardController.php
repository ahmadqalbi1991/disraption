...
class DashboardController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $total_artists = User::where('user_type_id', 3)->count();

        // Get active artist count
        $active_artists = User::where('user_type_id', 3)->where('active', 1)->count();

        // Get total customer count
        $total_customers = User::where('user_type_id', 2)->where('phone_verified',1)->count();
