...
@section('content')
    <div class="card mb-5">
        <div class="card-body">
            <div class="col-xs-12">
                <form method="post" id="admin-form" action="{{ url('admin/save_facility') }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <label>Facility Name<b class="text-danger">*</b></label>
                            <input type="text" name="name" class="form-control" required
                                data-parsley-required-message="Enter Facility Name" value="{{ $name }}">
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" name="icon" class="form-control" data-role="file-image" data-preview="image-preview" data-parsley-trigger="change"
                                    ...
                                    <img id="image-preview" style="width:100px; height:90px;" class="img-responsive mt-2"
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        if (typeof res['errors'] !== 'undefined') {
                            ...
                            var m = res['message'] ||
                            'Unable to save facilty. Please try again later.';
                            App.alert(m, 'Oops!');
                        }
                    } else {
                        App.alert(res['message'], 'Success!');
                                setTimeout(function(){
                                    window.location.href = "{{ route('admin.facilities.index') }}";
                                },1500);
