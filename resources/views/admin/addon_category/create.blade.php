...
@section('content')
    <div class="card mb-5">
        <div class="card-body">
            <div class="">
                <form method="post" id="admin-form" action="{{ url('admin/save_addon_category') }}" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6">
                            <div class="form-group b_img_div">
                                ...
                                <input type="file" name="banner_image" class="form-control" onclick="this.value=null;"
                                    ...
                                    <img id="image-preview-b" style="width:300px; height:93px;" class="img-responsive mt-2"
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        App.alert(res['message'], 'Success!');
                                setTimeout(function(){
                                    window.location.href = "{{ route('admin.addon.category') }}";
                                },1500);
